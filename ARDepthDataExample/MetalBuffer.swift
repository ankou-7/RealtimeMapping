...
//  ARDepthDataExample
//
//  Created by yasue kouki on 2022/01/18.
...
extension MTLRenderCommandEncoder {
    ...
    func setVertexBuffer3<T>(_ vertexBuffer: MetalBuffer<T>, offset: Int = 0) {
        setVertexBuffer(vertexBuffer.buffer, offset: offset, index: 3)
    }
